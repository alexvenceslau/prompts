...
Uma coleção de **prompts detalhados e testados** que você pode copiar e colar diretamente em qualquer assistente de IA para gerar páginas completas e profissionais.

### ✨ Características dos prompts:

- ✅ Completos e prontos para usar
- ✅ Geram código HTML/CSS funcional
...
```
prompts/
├── landing-page-ai-prompts/      # Landing pages por segmento
│   └── landing-protecao-veicular.md
...
4. Ajuste as cores na seção "COLOR PALETTE" se desejar
5. Modifique os textos das seções conforme seu negócio
...
Todos os serviços acima permitem conectar seu próprio domínio (ex: www.suaempresa.com.br)
...
- 💪 Landing pages para academias
- 🏥 Sites para clínicas e consultórios
- 🎓 Páginas para cursos online
- E muito mais!
